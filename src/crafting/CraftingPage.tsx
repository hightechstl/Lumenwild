...
export function CraftingPage({state,act}:{state:GameState;act:(state:GameState)=>void}){
 ...
 return <section className="page crafting-page"><header className="illustrated-page-header workbench-header"><p>Field workbench</p><h1>Crafting journal</h1><span>Turn regional finds into practical expedition goods and keepsakes.</span></header>
