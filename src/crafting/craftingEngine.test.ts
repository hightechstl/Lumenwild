...
describe('crafting transactions',()=>{
 ...
 it('provides every requested output category',()=>expect(new Set(recipes.map(recipe=>recipe.category))).toEqual(new Set(['supply','offering','restorative','furniture','wearable','decor'])));
