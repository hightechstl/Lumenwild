...
export const acquisitionMaterialFor=(species:WildSpecies)=>species==='mosskit'?'softmoss':species==='galecrest'||species==='veilfin'?'cloudglass':species==='cragback'||species==='emberstride'?'amberstone':'wardenbark';
